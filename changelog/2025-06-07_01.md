...
- The work happened inside what was then a shared experimental Obsidian plugin repo. Several other plugins (image-gin, perplexed, plunk-it) would later fork from this same lineage — you can still see the shared early commits in their histories.
...
Everything that came after Cite-Wide's official extraction in July 2025 — the modal-based citation editor, the references panel, the Lossless Citation Spec, the integration with Perplexed's research output — built on the hex-encoding pattern that landed this day.

The fork from the shared starter repo happened a month later, on July 6, 2025. By then the citations work had matured enough to deserve its own home.
