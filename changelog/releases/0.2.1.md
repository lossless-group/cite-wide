---
title: "Cite-Wide 0.2.1 — Wider Paste Surface, Marketplace Polish"
lede: "All of 0.2.0's LLM-paste citation pipeline, with a Paste modal that's now wide enough for a real research dump and the manifest polish needed to ship cleanly through the new community.obsidian.md submission portal."
...
release_tag: "0.2.1"
release_url: "https://github.com/lossless-group/cite-wide/releases/tag/0.2.1"
...
- **Release on GitHub:** https://github.com/lossless-group/cite-wide/releases/tag/0.2.1
- **Prior release (0.2.0):** https://github.com/lossless-group/cite-wide/releases/tag/0.2.0 — the narrative for 0.2.0 was `git mv`'d into this file (0.2.1) and updated in place, so the prior version is reachable via `git log -- changelog/releases/0.2.1.md` rather than as a separate file
